package com.newwave.spade.web.rest;
...
import com.nwt.spade.web.rest.AccountResource;
...
public class AccountResourceTest {
    ...
    @Mock
    private SpringUserService mockUserService;
    ...
    public void setup() {
        ...
        doNothing().when(mockMailService).sendActivationEmail((SpringUser) anyObject(), anyString());
    ...
    public void testRegisterValid() throws Exception {
        ...
        SpringUser user = userRepository.findOneByLogin("joe");
    ...
    public void testRegisterInvalidLogin() throws Exception {
        ...
        SpringUser user = userRepository.findOneByEmail("funky@example.com");
    ...
    public void testRegisterInvalidEmail() throws Exception {
        ...
        SpringUser user = userRepository.findOneByLogin("bob");
        assertThat(user).isNull();
    }
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        SpringUser userDup = userRepository.findOneByEmail("alicejr@example.com");
    ...
    public void testRegisterDuplicateEmail() throws Exception {
        ...
        SpringUser userDup = userRepository.findOneByLogin("johnjr");
        assertThat(userDup).isNull();
    }
    ...
    public void testRegisterAdminIsIgnored() throws Exception {
        ...
        SpringUser userDup = userRepository.findOneByLogin("badguy");

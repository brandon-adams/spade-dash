...
public class SpringUserService {
    ...
    private final Logger log = LoggerFactory.getLogger(SpringUserService.class);
  ...
  //  @Inject
    ...
    public  SpringUser activateRegistration(String key) {
        ...
        SpringUser user = userRepository.findOneByActivationKey(key);
    ...
    public SpringUser createUserInformation(String login, String password, String firstName, String lastName, String email,
                                      String langKey) {
    ...
    public void updateUserInformation(String firstName, String lastName, String email) {
        SpringUser currentUser = userRepository.findOneByLogin(SecurityUtils.getCurrentLogin());
    ...
    public SpringUser getUserWithAuthorities() {
        SpringUser currentUser = userRepository.findOneByLogin(SecurityUtils.getCurrentLogin());

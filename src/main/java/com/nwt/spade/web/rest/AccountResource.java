...
public class AccountResource {
  ...
  //  @Inject
    ...
    public ResponseEntity<?> registerAccount(@Valid @RequestBody UserDTO userDTO, HttpServletRequest request) {
        SpringUser user = userRepository.findOneByLogin(userDTO.getLogin());
        if (user != null) {
    ...
    public ResponseEntity<String> activateAccount(@RequestParam(value = "key") String key) {
        SpringUser user = userService.activateRegistration(key);
        if (user == null) {
    ...
    public ResponseEntity<UserDTO> getAccount() {
        SpringUser user = userService.getUserWithAuthorities();
        if (user == null) {
            return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
        }
    ...
    public ResponseEntity<String> saveAccount(@RequestBody UserDTO userDTO) {
        SpringUser userHavingThisLogin = userRepository.findOneByLogin(userDTO.getLogin());
    ...
    public ResponseEntity<List<PersistentToken>> getCurrentSessions() {
        SpringUser user = userRepository.findOneByLogin(SecurityUtils.getCurrentLogin());
        if (user == null) {
            return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
        }
        return new ResponseEntity<>(
